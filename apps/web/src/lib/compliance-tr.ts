...
export const TURKISH_COMPLIANCE_RULES: RuleDefinition[] = [
  // 1. Sağlık ve Tıbbi İddialar (TİTCK & Sağlık Bakanlığı)
  {
    ...
    legalBasis: "12 Kasım 2025 tarih ve 33075 sayılı R.G. Sağlık Hizmetlerinde Tanıtım ve Bilgilendirme Faaliyetleri Hakkında Yönetmelik md. 5 & 1219 sayılı Kanun",
    penaltyRisk: "6502 S.K. md. 77 uyarınca 2026 yılı yeniden değerleme oranıyla internet ortamında 8.635.800 TL'ye varan idari para cezası ve reklam durdurma.",
  ...
  },
  {
    ...
    legalBasis: "12 Kasım 2025 tarih ve 33075 sayılı R.G. Sağlık Tanıtım Yönetmeliği md. 5/1-ç (Haksız rekabet ve üstünlük iddiası yasağı)",
    penaltyRisk: "Reklam Kurulu para cezası (2026 tavanı 8.635.800 TL) ve Tabip Odası disiplin cezası.",
  ...
  },
  {
    ...
    legalBasis: "12 Kasım 2025 tarih ve 33075 sayılı R.G. Sağlık Tanıtım Yönetmeliği md. 5/1-d",
    penaltyRisk: "Web sayfasına BTK re'sen erişim engeli ve 8.635.800 TL'ye varan Reklam Kurulu cezası.",
  ...
  // 4. Finans, Kredi ve Yatırım (SPK & BDDK)
  {
    ...
    legalBasis: "7518 sayılı Kripto Varlık Kanunu & 6362 sayılı Sermaye Piyasası Kanunu md. 106-107",
    penaltyRisk: "SPK idari para cezası ve 2 yıldan 5 yıla kadar hapis cezası talebi.",
