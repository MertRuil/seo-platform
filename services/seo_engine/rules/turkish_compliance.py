...
TURKISH_REGULATORY_RULES = [
    ...
    # -------------------------------------------------------------
    {
        ...
        "legal_basis": "1219 sayılı Tababet Kanunu & Sağlık Hizmetlerinde Tanıtım ve Bilgilendirme Yönetmeliği md. 5",
        "penalty_risk": "TİTCK ve Ticaret Bakanlığı Reklam Kurulu tarafından idari para cezası ve reklam durdurma.",
    ...
    },
    {
        ...
        "legal_basis": "Sağlık Hizmetlerinde Tanıtım ve Bilgilendirme Faaliyetleri Yönetmeliği md. 5/1-ç (Haksız rekabet ve üstünlük iddiası yasağı)",
        "penalty_risk": "Reklam Kurulu para cezası ve Tabip Odası Disiplin soruşturması.",
    ...
    },
    {
        ...
        "legal_basis": "Sağlık Hizmetlerinde Tanıtım Yönetmeliği md. 5/1-d (Önce/sonra görseli ve mutlak başarı vaadi yasağı)",
        "penalty_risk": "Web sayfasına erişim engeli ve Reklam Kurulu cezası.",
    ...
    # -------------------------------------------------------------
    {
        ...
        "legal_basis": "6362 sayılı Sermaye Piyasası Kanunu md. 106-107 (Yatırımcıyı Yanıltma & Piyasa Dolandırıcılığı)",
    ...
    },
    {
        ...
        "suggested_fix": "Yalnızca BDDK yetkili banka ve finansman kuruluşlarının resmi faiz oranlarını listeyin.",
        "severity": IssueSeverity.CRITICAL,
    },
